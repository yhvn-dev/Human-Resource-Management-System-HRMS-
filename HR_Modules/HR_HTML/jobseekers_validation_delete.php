...
if($_SERVER["REQUEST_METHOD"] === "POST"){
    ...
    if(isset($_POST["js_id_inp"]) && !empty($_POST["js_id_inp"])){
        ...
        $delete_success [] =  "Jobseekers Deleted Sucessfully";
        $_SESSION["reject_js_success"] = $delete_success ;
        
        header("Location: dashboard.php?='jobseekers_deleted_succesfully!");
        exit();
...
<div class="reject_val_wrapper">
        ...
        <div class="template fp_reject_val_wrapper">
            ...
            <div class="container jobssekers_text_div">
                    ...
                    <p id="rjct-text_main_text" id="rjct-text_main_text">Delete Jobseeker  
