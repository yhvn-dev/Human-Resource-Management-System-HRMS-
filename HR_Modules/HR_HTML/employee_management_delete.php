...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (isset($_POST["emp_prim_id_holder"]) && !empty($_POST["emp_prim_id_holder"])) {
       ...
       delete_employee($pdo, $id);

      
        $delete_success[] = "Employee Deleted Successfully!";
        $_SESSION["delete_js_success"] = $delete_success;

        // 
        header("Location: employee_management_db.php?status=employee_deleted_successfully");
        exit();
...
<head>
    ...
    <link rel="stylesheet"  href="../HR_CSS/employee_management_delete.css">
...
<div class="delete_val_wrapper">

        <div class="template bd_delete_val_wrapper">

                

        </div>

        <div class="template fp_delete_val_wrapper">

            <div class="container jobssekers_text_div">

                    <img width="60" src="../../HRMS_Images/NodeLab LOGO 1.png">

                    <p id="delete-text_main_text" id="delete-text_main_text"> Delete Employee
                                        
                        <p class="delete_text delete-text_js_name"> <?php  echo $employee_id  ?> </p> ?
            ...
            <orm class="container js_main_data_div">
                    ...
                    <form class="button_form" method="POST">
                        ...
                        <div class="button_div">
                            ...
                            <button class="delete_emp_btn"  id="delete_button">Delete</button>
                            <a href="employee_management_db.php" class="delete_emp_btn"  id="discard-btn">Discard</a>
