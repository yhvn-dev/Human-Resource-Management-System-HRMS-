...
if($_SERVER["REQUEST_METHOD"] === "POST"){
    ...
    if(isset($_POST["js_id_inp"]) && !empty($_POST["js_id_inp"])){
        ...
        reject_jobseekers($pdo, $jobseekers_id);

        $reject_success[] =  "Jobseekers Rejected Sucessfully";
        $_SESSION["reject_js_success"] = $reject_success;
        
        header("Location: dashboard.php?='jobseekers_rejected_succesfully!");
        exit();
...
<head>
    ...
    <link rel="stylesheet"  href="../HR_CSS/jobseekers_validation_reject.css">
...
<div class="reject_val_wrapper">

        <div class="template bd_reject_val_wrapper">

                

        </div>

        <div class="template fp_reject_val_wrapper">

            <div class="container jobssekers_text_div">

                    <img width="60" src="../../HRMS_Images/NodeLab LOGO 1.png">

                    <p id="rjct-text_main_text" id="rjct-text_main_text">Reject Jobseeker  
                                        
                        <p class="reject_text rjct-text_js_name"> <?php  echo $first_name ?></p>?
            ...
            <div class="container js_main_data_div">
                    ...
                    <form class="main_data_divs button_div" method="POST">
                            ...
                            <button class="rjct-btn reject-btn" >Reject</button>
                            <a href="../../HR_Modules/HR_HTML/dashboard.php" class="rjct-btn discard-btn">Discard</a>
