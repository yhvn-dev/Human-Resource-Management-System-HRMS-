...
if($_SERVER["REQUEST_METHOD"] === "POST"){
    ...
    if(isset($_POST["js_id_inp"]) && !empty($_POST["js_id_inp"])){
        ...
        approve_jobseekers($pdo, $jobseekers_id);

        $approve_success[]  = "Jobseekers Approved Successfully"; 
        $_SESSION["approve_js_success"] =  $approve_success;

        header("Location: dashboard.php?='jobseekers_approved_succesfully!");
        exit();
...
<head>
    ...
    <link rel="stylesheet" href="../HR_CSS/jobseekers_validation_approve.css">
    ...
    <body>
        ...
        <div class="approve_val_wrapper">

                <div class="template bd_approve_val_wrapper">

                        

                </div>

                <div class="template fp_approve_val_wrapper">

                    <div class="container jobssekers_text_div">

                            <img width="60" src="../../HRMS_Images/NodeLab LOGO 1.png">

                            <p id="appr-text_main_text" id="appr-text_main_text">Approve Jobseeker  
                                                
                                <p class="approve_text appr-text_js_name"> <?php  echo $first_name ?></p>?
                    ...
                    <div class="container js_main_data_div">
                            ...
                            <form class="main_data_divs button_div" method="POST">
                                    ...
                                    <input type="hidden" id="appr_id_holder" name="js_id_inp" value="<?php echo $jobseekers_id ?> ">

                                    <button class="appr-btn approve-btn" >Approve</button>
                                    <a href="../../HR_Modules/HR_HTML/dashboard.php" class="appr-btn discard-btn">Discard</a>
